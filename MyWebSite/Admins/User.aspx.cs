...
namespace MyWebSite.Admins
{
	public partial class User : System.Web.UI.Page
	{
		...
		{
			grdUser.DataSource = UserService.User_GetByTop("","","");
			grdUser.DataBind();
        ...
        void LoadFilterDrop()
        {
            ...
            List<MyWebSite.Data.Rule> list = RuleService.Rule_GetByTop("", "", "");
            for (int i = 0; i < list.Count; i++)
            {
                ddlFilterRule.Items.Add (new ListItem( list[i].Name, list[i].Id));
            }
		...
		protected void Update_Click(object sender, EventArgs e)
		{
			if (Page.IsValid){
                ...
                obj.RuleId = ddlFilterRule.SelectedValue;
