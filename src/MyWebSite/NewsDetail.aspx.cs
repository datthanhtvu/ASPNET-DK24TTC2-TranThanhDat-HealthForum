...
namespace MyWebSite
{
    public partial class NewsDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.RouteData.Values["New"] != null)
            {
                TagNews = Page.RouteData.Values["New"].ToString();
            }

            if (Page.RouteData.Values["Name"] != null)
            {
                TagNews = Page.RouteData.Values["Name"].ToString();
            }
            Update_Click();
            if (!IsPostBack)
            {
        ...
        void View()
        {
            ...
            if (list.Count > 0)
            {
                ...
                {
                    Chuoi += "<tr><td valign=\"top\" align=\"left\" style=\"width: 8px; padding-top: 5px; padding-left: 3px; padding-right: 5px\"><img style=\"background: 0px\" src=\"/App_Themes/Default/images/nut_tinnoibat1.png\"> </td><td align=\"left\" style=\"padding-right: 4px;\"><a href=\"" + listNewsOther[i].Tag + ".htm\" class=\"newsother\">" + listNewsOther[i].Name + "</a> <font style=\"font-weight: normal; font-size: 8pt; color: #2055c7; font-family: Tahoma\">(" + listNewsOther[i].Date + ")</font></td></tr>";
                }
                Chuoi += "</table>";
            }
            Page.Title = "Tin tức/"+list[0].Name+"";
            list.Clear();
            list = null;
        ...
        void Update_Click()
        {
            Business.NewsService.News_Update_Click(TagNews);
