<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CommentCheck.aspx.cs" Inherits="MyWebSite.Admins.CommentCheck" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnView" runat="server">
        <%--<div id="search_block">
            Chuyên mục:
            <asp:DropDownList ID="ddlFilterEnquiry" runat="server">
            </asp:DropDownList>
        ...
        <div class="Control">
            <ul>
                ...
                <li>
                <asp:LinkButton CssClass="vactiveall" ID="lbtActiveAll" runat="server" OnClick="ActiveAll_Click">Cho phép hiển thị</asp:LinkButton></li>
        ...
        <asp:DataGrid ID="grdComment" runat="server" Width="100%" CssClass="TableView" AutoGenerateColumns="false"
            AllowPaging="true" PageSize="30" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center"
            OnItemCommand="grdComment_ItemCommand" OnItemDataBound="grdComment_ItemDataBound" OnPageIndexChanged="grdComment_PageIndexChanged">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="FullName" HeaderText="Tên độc giả" ItemStyle-CssClass="Text"
                    Visible="true" />
                <asp:BoundColumn DataField="Detail" HeaderText="Nội dung" ItemStyle-CssClass="Text"
                    Visible="true" />
        ...
        <div class="Control">
            <ul>
                ...
                <li>
                 ...
                 <li>
                <asp:LinkButton CssClass="vactiveall" ID="lbtActiveAllB" runat="server" OnClick="ActiveAll_Click">Cho phép hiển thị</asp:LinkButton></li>
    ...
    <asp:Panel ID="pnUpdate" runat="server" Visible="false">
        <table class="TableUpdate" border="1">
            ...
            <tr>
                <th>
                    <asp:Label ID="lblEnquiryId" runat="server" Text="Chuyên mục:"></asp:Label>
                </th>
              
            </tr>
            <tr>
                <th>
                    <asp:Label ID="lblName" runat="server" Text="Tên độc giả:"></asp:Label>
                </th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtEmail" runat="server" CssClass="text"></asp:TextBox><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="*"
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDetail" runat="server" CssClass="text multiline" TextMode="MultiLine"
