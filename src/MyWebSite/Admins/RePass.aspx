<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RePass.aspx.cs" Inherits="MyWebSite.Admins.RePass" %>
...
<table width="410" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="top_bg2">Thay đổi mật khẩu</td>
  </tr>
  <tr>
    <td class="bg_main" align="center"><table width="94%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td class="logname">Password cũ : </td>
        <td>
         ...
         <tr>
        <td class="logname">Password Mới : </td>
        <td>
            <asp:TextBox ID="txtPasswordNews" runat="server" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator>
          </td>
      </tr>
         <tr>
        <td class="logname">Nhập lại Password Mới : </td>
        <td>
            <asp:TextBox ID="txtPasswordNews2" runat="server" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator>
          </td>
      </tr>
      ...
      <tr>
        <td colspan="2" height="2px"><div style="background:#001eed"></div></td>
      </tr>
      </table></td>
  </tr>
