...
namespace MyWebSite.Common
{
    public class DateTimeClass
    {
        ...
        {
            return ConvertDateTime(DateTime, "MM/dd/yyyy hh:mm:ss tt");
        }
        public static string ConvertDateTimeMMddyyyyNoHH(string DateTime)
        {
            return ConvertDateTime(DateTime, "MM/dd/yyyy");
        }
        /// <summary>
        /// Convert string Datetime
        /// </summary>
