...
namespace MyWebSite.Common
{
    public class PageHelper : System.Web.UI.UserControl
    {
        ...
        {
            string[] myArr = new string[] { "1,Banner", "2,Quảng cáo bên phải", "3,Quảng cáo bên dưới", "4,Quảng cáo bên trái",  };
        ...
        {
            string strString = "";
            string[] myArr = new string[] { "1,Top banner", "2,Quảng cáo bên phải", "3,Quảng cáo bên dưới", "4,Quảng cáo bên trái",  };
            char[] splitter = { ',', ';' };
        ...
        {
            string[] myArr = new string[] { "1,Menu chính" };
            LoadDropDownList(ddl, myArr, true);
        }
